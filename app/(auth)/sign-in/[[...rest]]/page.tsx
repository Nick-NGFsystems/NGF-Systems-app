...
export default function SignInPage() {
  return (
    <main className="min-h-screen bg-slate-900 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-6xl items-center justify-center sm:min-h-[calc(100vh-4rem)]">
        <section className="w-full rounded-2xl border border-slate-700 bg-slate-900 p-4 shadow-sm sm:p-6 lg:p-10">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center text-center lg:text-left">
              <p className="font-sans text-3xl font-semibold tracking-tight text-blue-400">NGFsystems</p>
              <h1 className="mt-6 font-sans text-3xl font-semibold tracking-tight text-white sm:text-4xl lg:max-w-md">
                Client Portal &amp; Business Management
              </h1>
              <p className="mt-4 text-base text-slate-300 lg:max-w-md">
