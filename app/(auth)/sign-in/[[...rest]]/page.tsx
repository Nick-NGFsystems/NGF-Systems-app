...
export default function SignInPage() {
  return (
    <>
      ...
      <main className="hidden min-h-screen bg-slate-900 px-6 py-8 lg:block lg:px-8">
        <div className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center justify-center">
          <section className="w-full rounded-2xl border border-slate-700 bg-slate-900 p-10 shadow-sm">
            <div className="grid grid-cols-2 gap-12">
              ...
              <div className="flex items-center justify-center">
                <div className="w-full max-w-md rounded-2xl border border-slate-700 bg-white p-6 shadow-sm">
                  <SignIn
                    appearance={{
                      elements: {
