          ...
          <div className="order-2 flex flex-col justify-between gap-10 bg-slate-950 p-6 text-white sm:p-10 lg:order-1 lg:p-12">
            <div>
              ...
              <h1 className="mt-6 max-w-lg font-sans text-3xl font-semibold tracking-tight sm:text-4xl">
                Sign in to manage clients, projects, invoices, and website requests.
              </h1>
              <p className="mt-4 max-w-md text-sm leading-6 text-slate-300 sm:text-base">
                Use the admin and client portal to keep work moving without chasing updates across email and spreadsheets.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
                ...
                <p className="mt-2 text-sm text-slate-100">Track milestones, approvals, and status in one place.</p>
              </div>
              <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
                <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Billing</p>
                <p className="mt-2 text-sm text-slate-100">Review invoices and payment history without leaving the portal.</p>
              </div>
            </div>
          </div>
