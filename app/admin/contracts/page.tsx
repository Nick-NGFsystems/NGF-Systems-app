...
const emptyState: EmptyState = {
  ...
  description: 'Store signed agreements and renewal timelines here once contracts are created.',
}
  ...
  return (
    <section className="space-y-8">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="font-sans text-3xl font-semibold tracking-tight text-slate-900">Contracts</h1>
        <button
          type="button"
